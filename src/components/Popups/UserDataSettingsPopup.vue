        ...
        <div  class="overlay">
            <div class="popup__wrapper" v-click-outside="()=>{$emit('close')}">
                <div class="popup__header">
                    <div class="poput-title">User Settings</div>
                ...
                <div class="popup__body">
                    <UserDataSettings :isLoginForm="false" :initData="myUserData" @close="$emit('close')"></UserDataSettings>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    computed:{
        myUserData(){
            return this.$store.state.myUserData
        }
    }
}
</script>