        ...
        <div  class="overlay">
            <div class="popup__wrapper" v-click-outside="()=>{$emit('close')}">
                <div class="popup__header">
                    <div class="poput-title">Confirmation</div>
                ...
                <div class="popup__body">
                    <div class="popup__text popup__text-centr">
                        {{text}}
                    </div>
                    <div class="popup__buttons">
                        <div @click="$emit('confirm')" class="btn btn--blue popup__button ">Confirm</div>
                        <div @click="$emit('cancel')" class="btn popup__button">Cancel</div>
                    </div>
                </div>
            </div>
        </div>
